...
class BotFeedback(SQLModel, table=True):
    ...
    Args:
        bf_id (int): Feedback ID, auto-incremented.
    ...
    bf_id: int = id_field("botfeedback")
    bf_m_id: int = Field(foreign_key="messages.m_id", index=True)
    bf_c_id: int = Field(foreign_key="customers.c_id")
...
class Notifications(SQLModel, table=True):
    ...
    Args:
        n_id (int): Notification ID, auto-incremented.
    ...
    n_id: int = id_field("notifications")
    n_c_id: int = Field(foreign_key="customers.c_id", index=True)
...
class StoreSettings(SQLModel, table=True):
    ...
    Args:
        ss_id (int): Setting ID, auto-incremented.
    ...
    __table_args__ = (UniqueConstraint("ss_s_id", "ss_key", name="unique_store_setting"),)

    ss_id: int = id_field("storesettings")
...
class BusinessHours(SQLModel, table=True):
    ...
    Args:
        bh_id (int): Business hours ID, auto-incremented.
    ...
    bh_id: int = id_field("businesshours")
...
class DeliveryZones(SQLModel, table=True):
    ...
    Args:
        dz_id (int): Zone ID, auto-incremented.
    ...
    dz_id: int = id_field("deliveryzones")
...
class Deliveries(SQLModel, table=True):
    ...
    Args:
        d_id (int): Delivery ID, auto-incremented.
...
class BotAnalytics(SQLModel, table=True):
    ...
    Args:
        ba_id (int): Analytics ID, auto-incremented.
    ...
    ba_id: int = id_field("botanalytics")
...
class AuditLog(SQLModel, table=True):
    ...
    Args:
        al_id (int): Log entry ID, auto-incremented.
